...
/// guarded-by: busbars_test2.zig "a rail reports licensed or foreign without changing bytes"
const Chan = struct {
...
/// guarded-by: busbars.zig "licenceAt trusts identity only after a complete consistent stamp"
